...
urlpatterns = [
    ...
    path(
        "<slug:main_category_slug>/<slug:sub_category_slug>/",
        views.listings_view,
        name="products_by_category",
    ),
    path(
        "<slug:main_category_slug>/<slug:sub_category_slug>/<slug:sub_sub_category_slug>",
        views.listings_view,
        name="products_by_category",
    ),
    path(
        "<slug:main_category_slug>/<slug:sub_category_slug>/<slug:product_slug>/",
        views.product_detail,
        name="product_detail",
    ),
    path(
        "<slug:main_category_slug>/<slug:sub_category_slug>/<slug:sub_sub_category_slug>/<slug:product_slug>/",
        views.product_detail,
        name="product_detail",
    ),
    path(
    ...
    path(
        ...
        views.developerske_projekty,
        name="developerske_projekty",
    ),
